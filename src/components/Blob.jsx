function Blob(props) {
  ...
  if (props.color === "blue") {
    blob = 
      <svg className="blob blob--blue" xmlns="http://www.w3.org/2000/svg" width="148" height="118" viewBox="0 0 148 118" fill="none">
    ...
    blob = 
      <svg className="blob blob--yellow" xmlns="http://www.w3.org/2000/svg" width="158" height="141" viewBox="0 0 158 141" fill="none">
